...
$.fn.swipePlanes = function(opciones){
    return this.each(function(){
        ...
        $(this).mouseout(function(){
			...
			/*
			* Hide paginator on mouseout
			* Write by Paulo R. S. de Sousa
			*/
			$('.'+randId+'swipePlanesPaginator').css('opacity','0');
        });
		
		/*
		* Show paginator just on mouseover
		* Write by Paulo R. S. de Sousa
		*/
		$(this).mouseover(function(){
			$('.'+randId+'swipePlanesPaginator').css('opacity','1');
        });
